...
@Component({
  selector: 'app-score-board-legacy',
  templateUrl: './score-board-legacy.component.html',
  styleUrls: ['./score-board-legacy.component.scss']
})
export class ScoreBoardLegacyComponent implements OnInit, AfterViewInit {
